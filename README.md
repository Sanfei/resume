...
2018/01 - 2019/05 深圳城轨运维监控平台

- 责任描述：前端开发
- 项目简介：
  深圳地铁系统的运维监控信息系统，其特点是前后端分离项目。
  前端纯HTML和JavaScript,使用AJAX请求后端的Web API。
  后端模块式结构，可扩展设计，除核心模块外，其他牵引、制动、信号、空调等模块都作为第三方应用存在。
  使用了Vue.js框架，iView图形组件。
